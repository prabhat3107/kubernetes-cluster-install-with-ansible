...
project_folder_name = "KubernetesLabs/k8sp-u22.04"
...
vm_list = [
  {
    vm_name      = "k8sp-master1"
    vm_host_name = "k8sp-master1"
    vm_num_cpus  = 4
    vm_memory    = 8192
    vm_nic_config = [
      {
  ...
  {
    vm_name      = "k8sp-master2"
    vm_host_name = "k8sp-master2"
    vm_num_cpus  = 4
    vm_memory    = 8192
    vm_nic_config = [
      {
